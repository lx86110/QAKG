...
class EntityExtractor:
    def __init__(self):
        ...
        self.disease_path = cur_dir + 'data/disease_vocab.txt'
        self.symptom_path = cur_dir + 'data/symptom_vocab.txt'
        self.alias_path = cur_dir + 'data/alias_vocab.txt'
        self.complication_path = cur_dir + 'data/complications_vocab.txt'
